...
const CinematicEntry: React.FC<CinematicEntryProps> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      ...
      <p className="name-text flex text-[20vw] lg:text-[200px] heading-font !text-white text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden will-change-transform">
