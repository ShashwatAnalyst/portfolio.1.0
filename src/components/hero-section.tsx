        ...
        <div className="flex justify-center lg:justify-end">
          {isSmallScreen ? (
            <div className="relative">
              <div className="relative top-[10px] h-[100px] w-[100px] mx-auto rounded-full overflow-hidden border-4 border-gray-800 dark:border-border backdrop-blur-sm transform hover:scale-105 transition-all duration-500 hover:rotate-2 animate-float z-10">
                <img
